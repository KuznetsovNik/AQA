...
@TmsLink("https://vmmreg32.testrail.net/index.php?/cases/view/6386124")
public class AuthValidPassportRuTest extends BaseAuthorization {

    @Test(suiteName = "user_service", groups = {"smoke", "regression"})
    @Description("Паспорт РФ. Валидные данные")
    void authWithPassportRu() {
