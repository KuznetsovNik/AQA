...
@Owner("Яроцкая Е.И.")
@Story("CreditService")
public class SuccessfulSubmissionOfLoanPaymentScheduleTest extends BaseClassWithAuthToken {

    @Test( groups = {"smoke"})
    @TmsLink("https://vmmreg32.testrail.net/index.php?/cases/view/6220278")
    @Description("Успешная отправка графика платежей по кредиту. Не реализован функционал")
