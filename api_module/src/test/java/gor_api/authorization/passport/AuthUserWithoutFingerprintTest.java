...
public class AuthUserWithoutFingerprintTest extends BaseAuthorization {
    ...
    void authWithPassportTest() {
        JsonResponse auth = authApiService.postNotFingerprint(body(PASSPORT_RU.getCode(), LOGIN_VALID_PASSPORT_RU, VALID_PASSWORD, TYPE_DOCUMENT));
